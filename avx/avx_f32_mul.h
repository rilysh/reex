#ifndef AVX_F32_MUL_H
#define AVX_F32_MUL_H

#include <immintrin.h>
#include "avx.h"
#include "../rdtsc.h"

static __inline__ float avx_f32_mul(unsigned int iter)
{
    __m256 c0 = _mm256_set1_ps(1.4142135623730950488f);
    __m256 c1 = _mm256_set1_ps(1.6422289836162283477f);
    ...
    while (iter--) {
        ...
        v0 = _mm256_mul_ps(v0, c1);
        v1 = _mm256_mul_ps(v1, c1);
        v2 = _mm256_mul_ps(v2, c1);
        v3 = _mm256_mul_ps(v3, c1);
        v4 = _mm256_mul_ps(v4, c1);
        v5 = _mm256_mul_ps(v5, c1);
        v6 = _mm256_mul_ps(v6, c1);
        v7 = _mm256_mul_ps(v7, c1);
