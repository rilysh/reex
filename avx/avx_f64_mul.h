#ifndef AVX_F64_MUL_H
#define AVX_F64_MUL_H

#include <immintrin.h>
#include "avx.h"
#include "../rdtsc.h"

static __inline__ double avx_f64_mul(unsigned int iter)
{
    __m256d c0 = _mm256_set1_pd(1.4142135623730950488f);
    __m256d c1 = _mm256_set1_pd(1.6422289836162283477f);
    ...
    while (iter--) {
        ...
        v0 = _mm256_mul_pd(v0, c1);
        v1 = _mm256_mul_pd(v1, c1);
        v2 = _mm256_mul_pd(v2, c1);
        v3 = _mm256_mul_pd(v3, c1);
        v4 = _mm256_mul_pd(v4, c1);
        v5 = _mm256_mul_pd(v5, c1);
        v6 = _mm256_mul_pd(v6, c1);
        v7 = _mm256_mul_pd(v7, c1);
