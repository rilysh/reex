#ifndef AVX_F32_SUB_H
#define AVX_F32_SUB_H

#include <immintrin.h>
#include "avx.h"
#include "../rdtsc.h"

static __inline__ float avx_f32_sub(unsigned int iter)
{
    __m256 c0 = _mm256_set1_ps(1.414213562373f);
    __m256 c1 = _mm256_set1_ps(1.889226855369f);
    ...
    while (iter--) {
        v0 = _mm256_sub_ps(v0, c0);
        v1 = _mm256_sub_ps(v1, c0);
        v2 = _mm256_sub_ps(v2, c0);
        v3 = _mm256_sub_ps(v3, c0);
        v4 = _mm256_sub_ps(v4, c0);
        v5 = _mm256_sub_ps(v5, c0);
        v6 = _mm256_sub_ps(v6, c0);
        v7 = _mm256_sub_ps(v7, c0);
