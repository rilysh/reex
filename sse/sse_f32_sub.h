#ifndef SSE_F32_SUB_H
#define SSE_F32_SUB_H

#include <xmmintrin.h>
#include "sse.h"
#include "../rdtsc.h"

static __inline__ float sse_f32_sub(unsigned int iter)
{
    __m128 c0 = _mm_set1_ps(1.414213562373f);
    __m128 c1 = _mm_set1_ps(1.889226855369f);
