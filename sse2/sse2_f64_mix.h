#ifndef SSE2_F64_MIX_H
#define SSE2_F64_MIX_H

#include <emmintrin.h>
#include "sse2.h"
#include "../rdtsc.h"

static __inline__ double sse2_f64_mix(unsigned int iter)
{
    __m128d c0 = _mm_set1_pd(3.4658718895467154448f);
    __m128d c1 = _mm_set1_pd(1.289668251764486206f);
