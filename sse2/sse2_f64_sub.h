#ifndef SSE2_F64_SUB_H
#define SSE2_F64_SUB_H

#include <emmintrin.h>
#include "sse2.h"
#include "../rdtsc.h"

static __inline__ double sse2_f64_sub(unsigned int iter)
{
    __m128d c0 = _mm_set1_pd(1.414213562373f);
    __m128d c1 = _mm_set1_pd(1.889226855369f);
